...
<head>
  ...
  <meta name="keywords" content="">
    ...
    <?php 
      ...
      $productTalla = "M";
      $productImg1 = "./src/assets/images/products/product-page-1.jpeg";
      $productImg2 = "./src/assets/images/products/product-page-2.jpeg";
      $productImg3 = "./src/assets/images/products/product-page-3.jpeg";
      $productImg4 = "./src/assets/images/products/product-page-4.jpeg";
      $productDescription = "Hecho de 100% algodón orgánico, la Camiseta Osaka Japón de Kiikii fue creada pensando en el uso diario. Presenta gráficos impresos y tela de gran peso para máxima comodidad y durabilidad.";
  ...
  <!-- Page Title -->
  <title>Bruz Deporte | Ver Producto </title>
            ...
            <div class="container-fluid">
                <nav class="m-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item breadcrumb-light"><a href="#"><?php echo $productType?></a></li>
            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="<?php echo $productImg1?>" alt="HTML Bootstrap Template by Pixel Rocket">
                            </picture>
                        </div>
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="<?php echo $productImg2?>" alt="HTML Bootstrap Template by Pixel Rocket">
                            </picture>
                        </div>
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="<?php echo $productImg3?>" alt="HTML Bootstrap Template by Pixel Rocket">
                            </picture>
                        </div>
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="<?php echo $productImg4?>" alt="HTML Bootstrap Template by Pixel Rocket">
                            </picture>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="pb-3" data-aos="fade-in">
                            ...
                            <div class="border-top mt-4 mb-3 product-option">
                                <small class="text-uppercase pt-4 d-block fw-bolder">
                                    <span class="text-muted">Disponible en Tallas</span> : <span class="selected-option fw-bold"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                    <picture class="me-2">
                                        <img class="f-w-24 p-2 bg-light border-bottom border-dark border-2 cursor-pointer" src="<?php echo $productImg1 ?>" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                </div>
                            </div>
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionProduct">
                                    <div class="accordion-body">
                                        <p class="m-0"><?php echo $productDescription; ?></p>
                                    </div>
                                  </div>
                                </div>
                                <div class="accordion-item">
